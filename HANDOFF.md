...
使用者詢問機箱自製或買現成。已在 `mechanical/機箱選擇.md` 記錄建議：優先現成鋁機箱＋客製面板，TAKACHI HY88-28-23 與 Hammond 1455U2801 作尺寸／結構比較。這是候選評估，尚未定案型號、報價或採購；V0.1 占位圖未改成實際裝配模型。機箱選型應與 PCB 初步配置同步，不能等 PCB 定型才檢查是否裝得下。
